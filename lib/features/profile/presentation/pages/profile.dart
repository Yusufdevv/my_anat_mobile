...
import 'package:anatomica/features/profile/presentation/pages/auto_payment_page.dart';
                      ...
                      child: ListView(
                        ...
                        children: [
                            ...
                            ProfileItem(
                                ...
                                onTap: () {
                                  Navigator.of(context, rootNavigator: true)
                                      .push(
                                    fade(
                                      // todo shaxsiy cabinet url change
                                      page: WebViewScreen(
                                        url:
                                            'https://my.anatomica.uz?token=${StorageRepository.getString("token")}&mobile=true',
                                        page: '',
                                      ),
                                    ),
                                  );
                          ...
                          ProfileItem(
                              ...
                              onTap: () {
                                Navigator.of(context, rootNavigator: true)
                                    .push(fade(page: const MyCardsScreen()));
                              }),
                          const SizedBox(height: 12),
                          ProfileItem(
                                  ...
                                  onTap: () async {
                                    Navigator.of(context, rootNavigator: true)
                                      ...
                                      fade(
                                        page: WebViewScreen(
                                          url:
                                              'https://my.anatomica.uz/mobile-auth/?token=${StorageRepository.getString(StoreKeys.token)}&mobile=true&page=CreateDoctorPage',
                                  ...
                                  onTap: () async {
                                    Navigator.of(context, rootNavigator: true)
                                      ...
                                      fade(
                                        page: WebViewScreen(
                                          url:
                                              "https://my.anatomica.uz/mobile-auth/?token=${StorageRepository.getString(StoreKeys.token)}&mobile=true&page=CreateOrganizationPage",
