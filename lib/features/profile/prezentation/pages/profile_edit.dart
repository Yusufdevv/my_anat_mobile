...
import 'package:anatomica/features/profile/prezentation/blocs/image_bloc/image_bloc.dart';
...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  _imgFromGallery(BuildContext context) async {
    imageBloc.add(GetImageEvent(isFromGallery: true));
    Navigator.of(context).pop();
  }

  void _imgFromCamera(BuildContext context) async {
    imageBloc.add(GetImageEvent(isFromGallery: false));
    Navigator.of(context).pop();
  }
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: SvgPicture.asset(AppIcons.editImage),
                              ),
                            ),
                          ],
                        ),
