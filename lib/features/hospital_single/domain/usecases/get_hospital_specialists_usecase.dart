...
class GetHospitalSpecialistsUseCase implements UseCase<GenericPagination<HospitalDoctorsEntity>, TypeParameter> {
  final HospitalSingleRepository repository;
  GetHospitalSpecialistsUseCase({required this.repository});
  @override
  Future<Either<Failure, GenericPagination<HospitalDoctorsEntity>>> call(TypeParameter params) async =>
      repository.getHospitalSpecialists(id: params.id, next: params.next);
}
