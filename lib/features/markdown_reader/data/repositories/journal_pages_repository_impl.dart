...
class JournalPagesRepositoryImpl extends JournalPagesRepository {
  ...
  @override
  Future<Either<Failure, GenericPagination<JournalOutlineEntity>>> getPagesTableOfContents({required String slug, String? next}) async {
    try {
      final result = await datasource.getPagesTableOfContents(slug: slug, next: next);
      return Right(result);
    } on DioException {
      return Left(DioFailure());
    } on ParsingException catch (e) {
