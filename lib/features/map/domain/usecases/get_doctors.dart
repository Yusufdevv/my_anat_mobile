...
class GetDoctorsUseCase
    extends UseCase<GenericPagination<DoctorsEntity>, SearchParam> {
  final PaginationRepository repo = PaginationRepository();

  @override
  Future<Either<Failure, GenericPagination<DoctorsEntity>>> call(
      SearchParam param) {
    return repo.fetchMore<DoctorsEntity>(
        url: '/doctor/',
