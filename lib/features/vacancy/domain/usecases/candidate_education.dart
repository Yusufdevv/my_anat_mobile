...
class CandidateEducationUseCase extends UseCase<GenericPagination<CandidateEducationEntity>, int> {
  final VacancyRepository repository;

  CandidateEducationUseCase({required this.repository});

  @override
  Future<Either<Failure, GenericPagination<CandidateEducationEntity>>> call(int id) async =>
      await repository.getCandidateEducation(id: id);
}
