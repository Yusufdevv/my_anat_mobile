...
abstract class VacancyRemoteDataSource {
  ...
  Future<GenericPagination<CandidateEducationFilesEntity>> getCandidateEducationFiles({required int id});
...
class VacancyRemoteDataSourceImpl extends VacancyRemoteDataSource {
  ...
  Future<VacancyModel> getVacancyList({String? next, VacancyParamsEntity? vacancyParamsEntity}) async {
    try {
      ...
      if (vacancyParamsEntity != null) {
        ...
        if (vacancyParamsEntity.salary != null && vacancyParamsEntity.salary!.isNotEmpty) {
          var value = '';
        ...
        if (vacancyParamsEntity.experience != null && vacancyParamsEntity.experience!.isNotEmpty) {
          var value = '';
        ...
        if (vacancyParamsEntity.district != null && vacancyParamsEntity.district!.isNotEmpty) {
          var value = '';
  ...
  @override
  Future<GenericPagination<CandidateEducationModel>> getCandidateEducation({required int id}) async {
    try {
  ...
  Future<GenericPagination<CandidateEducationFilesModel>> getCandidateEducationFiles({required int id}) async {
    try {
      ...
      if (response.statusCode! >= 200 && response.statusCode! < 300) {
        return GenericPagination.fromJson(
            response.data, (p0) => CandidateEducationFilesModel.fromJson(p0 as Map<String, dynamic>));
      }
      throw ServerException(statusCode: response.statusCode ?? 0, errorMessage: response.statusMessage ?? '');
    } on ServerException {
      rethrow;
