...
class _ResetPasswordBodyState extends State<ResetPasswordBody> with AutomaticKeepAliveClientMixin {
  bool isPhone = true;
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          ...
                          context.read<ResetPasswordBloc>().add(
                                ChangeConfirmationType(confirmationType: isPhone ? 'phone' : 'email'),
                              );
                        },
                        child: Padding(
                ...
                onTap: () {
                  if (state.confirmationType == 'phone') {
                    if (state.emailPhoneNumber.isNotEmpty) {
                      if (state.emailPhoneNumber.replaceAll(RegExp(r'\(?\)?-? ?'), '') ==
                      ...
                      context.read<ResetPasswordBloc>().add(CreateNewState(onSuccess: () {
                        context.read<ResetPasswordBloc>().add(
                              SubmitPhone(
                                phone: '+998${phoneController.text.replaceAll(RegExp(r' '), '')}',
                                onSuccess: () {
