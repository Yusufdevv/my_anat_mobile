              ...
              AnimatedPositioned(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: white,
                    border: Border.all(color: black.withOpacity(0.04), width: 0.5),
                    boxShadow: [
                      BoxShadow(blurRadius: 1, offset: const Offset(0, 3), color: black.withOpacity(0.06)),
                      BoxShadow(blurRadius: 8, offset: const Offset(0, 3), color: black.withOpacity(0.15)),
                    ],
                  ),
                ),
              )
